/*
Deployment script for HLS_Cheques
*/
...
CREATE TABLE [dbo].[Cheques] (
    ...
    [FechaGiro]           DATETIME        NULL,
    [Certificado]         BIT             NULL,
    [ComprobanteNro]      NVARCHAR (255)  NULL,
    [ImgCheque]           VARBINARY (MAX) NULL,
    [ImgFactura]          VARBINARY (MAX) NULL,
    [ImgComprobante]      VARBINARY (MAX) NULL,
    [ImgDocRespaldo]      VARBINARY (MAX) NULL,
    [Situacion]           NVARCHAR (1)    NULL,
    [Solicitar]           BIT             NULL,
    [SolicitudNro]        INT             NULL,
    [Observacion]         NVARCHAR (255)  NULL,
    [UsuarioCreacion]     NVARCHAR (255)  NULL,
    [FechaCreacion]       DATETIME        NULL,
    [UsuarioAprobacion]   NVARCHAR (255)  NULL,
    [FechaAprobación]     DATETIME        NULL,
    [UsuarioSolicitud]    NVARCHAR (255)  NULL,
    [FechaSolicitud]      DATETIME        NULL,
    [UsuarioEmision]      NVARCHAR (255)  NULL,
    [FechaEmision]        DATETIME        NULL,
    [UsuarioPago]         NVARCHAR (255)  NULL,
    [FechaPago]           DATETIME        NULL,
    [UsuarioAnulacion]    NVARCHAR (255)  NULL,
    [FechaAnulación]      DATETIME        NULL,
    [Cheque_CuentaBanco]  INT             NOT NULL,
    [Cheque_Beneficiario] INT             NOT NULL,
    [Cheque_Cobrador]     INT             NULL,
    [Cheque_Girador]      INT             NULL
);


GO
PRINT N'Creating PK_Cheques...';


GO
ALTER TABLE [dbo].[Cheques]
    ADD CONSTRAINT [PK_Cheques] PRIMARY KEY CLUSTERED ([Id] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);


GO
PRINT N'Creating UK_Cheques...';


GO
ALTER TABLE [dbo].[Cheques]
    ADD CONSTRAINT [UK_Cheques] UNIQUE NONCLUSTERED ([Nro] ASC, [Cheque_CuentaBanco] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);


GO
PRINT N'Creating [dbo].[CuentaBancos]...';
...
CREATE TABLE [dbo].[CuentaBancos] (
    [Id]                INT            IDENTITY (1, 1) NOT NULL,
    [RowVersion]        TIMESTAMP      NOT NULL,
    [CuentaNro]         NVARCHAR (255) NOT NULL,
    [Moneda]            NVARCHAR (255) NOT NULL,
    [CuentaBanco_Banco] INT            NOT NULL
);


GO
PRINT N'Creating PK_CuentaBancos...';


GO
ALTER TABLE [dbo].[CuentaBancos]
    ADD CONSTRAINT [PK_CuentaBancos] PRIMARY KEY CLUSTERED ([Id] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);


GO
PRINT N'Creating UK_CuentaBancos...';


GO
ALTER TABLE [dbo].[CuentaBancos]
    ADD CONSTRAINT [UK_CuentaBancos] UNIQUE NONCLUSTERED ([CuentaNro] ASC, [CuentaBanco_Banco] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);
...
GO
PRINT N'Creating PK_Beneficiarios...';


GO
ALTER TABLE [dbo].[Beneficiarios]
    ADD CONSTRAINT [PK_Beneficiarios] PRIMARY KEY CLUSTERED ([Id] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);


GO
PRINT N'Creating UK_Beneficiarios...';


GO
ALTER TABLE [dbo].[Beneficiarios]
    ADD CONSTRAINT [UK_Beneficiarios] UNIQUE NONCLUSTERED ([Nombre] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);


GO
PRINT N'Creating [dbo].[Cobradors]...';


GO
CREATE TABLE [dbo].[Cobradors] (
    [Id]         INT            IDENTITY (1, 1) NOT NULL,
    [RowVersion] TIMESTAMP      NOT NULL,
    [Nombre]     NVARCHAR (255) NOT NULL
);
...
GO
PRINT N'Creating PK_Cobradors...';


GO
ALTER TABLE [dbo].[Cobradors]
    ADD CONSTRAINT [PK_Cobradors] PRIMARY KEY CLUSTERED ([Id] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);


GO
PRINT N'Creating UK_Cobradors...';


GO
ALTER TABLE [dbo].[Cobradors]
    ADD CONSTRAINT [UK_Cobradors] UNIQUE NONCLUSTERED ([Nombre] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);
...
GO
PRINT N'Creating UK_Emails...';


GO
ALTER TABLE [dbo].[Emails]
    ADD CONSTRAINT [UK_Emails] UNIQUE NONCLUSTERED ([RolMail] ASC, [Destinatario] ASC, [Mail] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);
...
CREATE TABLE [dbo].[Bancos] (
    [Id]         INT            IDENTITY (1, 1) NOT NULL,
    [RowVersion] TIMESTAMP      NOT NULL,
    [Sigla]      NVARCHAR (255) NOT NULL,
    [Nombre]     NVARCHAR (255) NOT NULL
);


GO
PRINT N'Creating PK_Bancos...';


GO
ALTER TABLE [dbo].[Bancos]
    ADD CONSTRAINT [PK_Bancos] PRIMARY KEY CLUSTERED ([Id] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);


GO
PRINT N'Creating UK_Bancos...';


GO
ALTER TABLE [dbo].[Bancos]
    ADD CONSTRAINT [UK_Bancos] UNIQUE NONCLUSTERED ([Sigla] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);


GO
PRINT N'Creating [dbo].[Giradors]...';


GO
CREATE TABLE [dbo].[Giradors] (
    [Id]         INT            IDENTITY (1, 1) NOT NULL,
    [RowVersion] TIMESTAMP      NOT NULL,
    [Nombre]     NVARCHAR (255) NOT NULL
);
...
GO
PRINT N'Creating PK_Giradors...';


GO
ALTER TABLE [dbo].[Giradors]
    ADD CONSTRAINT [PK_Giradors] PRIMARY KEY CLUSTERED ([Id] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);


GO
PRINT N'Creating [dbo].[SendMails]...';
...
GO
PRINT N'Creating PK_SendMails...';


GO
ALTER TABLE [dbo].[SendMails]
    ADD CONSTRAINT [PK_SendMails] PRIMARY KEY CLUSTERED ([Id] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);


GO
PRINT N'Creating UK_SendMails...';


GO
ALTER TABLE [dbo].[SendMails]
    ADD CONSTRAINT [UK_SendMails] UNIQUE NONCLUSTERED ([Fecha] ASC, [RolMail] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);


GO
PRINT N'Creating [dbo].[Secuencias]...';
...
CREATE TABLE [dbo].[Secuencias] (
    [Id]         INT            IDENTITY (1, 1) NOT NULL,
    [RowVersion] TIMESTAMP      NOT NULL,
    [Catagoria]  NVARCHAR (255) NOT NULL,
...
GO
PRINT N'Creating PK_Secuencias...';


GO
ALTER TABLE [dbo].[Secuencias]
    ADD CONSTRAINT [PK_Secuencias] PRIMARY KEY CLUSTERED ([Id] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);


GO
PRINT N'Creating UK_Secuencias...';


GO
ALTER TABLE [dbo].[Secuencias]
    ADD CONSTRAINT [UK_Secuencias] UNIQUE NONCLUSTERED ([Catagoria] ASC, [Clave] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);
...
GO
PRINT N'Creating PK_Logs...';


GO
ALTER TABLE [dbo].[Logs]
    ADD CONSTRAINT [PK_Logs] PRIMARY KEY CLUSTERED ([Id] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);


GO
PRINT N'Creating [dbo].[OperacionEMails]...';


GO
CREATE TABLE [dbo].[OperacionEMails] (
    [Id]                   INT             IDENTITY (1, 1) NOT NULL,
    [RowVersion]           TIMESTAMP       NOT NULL,
    [Enviante]             NVARCHAR (255)  NOT NULL,
    [Destinatario]         NVARCHAR (255)  NOT NULL,
    [Asunto]               NVARCHAR (255)  NOT NULL,
    [Cuerpo]               NVARCHAR (4000) NOT NULL,
    [InfoAdjunta]          VARBINARY (MAX) NULL,
    [NombreArchivoAdjunto] NVARCHAR (255)  NULL
);


GO
PRINT N'Creating PK_OperacionEMails...';


GO
ALTER TABLE [dbo].[OperacionEMails]
    ADD CONSTRAINT [PK_OperacionEMails] PRIMARY KEY CLUSTERED ([Id] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);
...
GO
PRINT N'Creating DF_Cheques_Nro...';


GO
ALTER TABLE [dbo].[Cheques]
    ADD CONSTRAINT [DF_Cheques_Nro] DEFAULT ('') FOR [Nro];


GO
PRINT N'Creating DF_Cheques_Concepto...';


GO
ALTER TABLE [dbo].[Cheques]
    ADD CONSTRAINT [DF_Cheques_Concepto] DEFAULT ('') FOR [Concepto];


GO
PRINT N'Creating DF_Cheques_Monto...';


GO
ALTER TABLE [dbo].[Cheques]
    ADD CONSTRAINT [DF_Cheques_Monto] DEFAULT ((0)) FOR [Monto];


GO
PRINT N'Creating DF_Cheques_Cheque_CuentaBanco...';


GO
ALTER TABLE [dbo].[Cheques]
    ADD CONSTRAINT [DF_Cheques_Cheque_CuentaBanco] DEFAULT ((0)) FOR [Cheque_CuentaBanco];


GO
PRINT N'Creating DF_Cheques_Cheque_Beneficiario...';


GO
ALTER TABLE [dbo].[Cheques]
    ADD CONSTRAINT [DF_Cheques_Cheque_Beneficiario] DEFAULT ((0)) FOR [Cheque_Beneficiario];


GO
PRINT N'Creating DF_CuentaBancos_CuentaNro...';


GO
ALTER TABLE [dbo].[CuentaBancos]
    ADD CONSTRAINT [DF_CuentaBancos_CuentaNro] DEFAULT ('') FOR [CuentaNro];


GO
PRINT N'Creating DF_CuentaBancos_Moneda...';


GO
ALTER TABLE [dbo].[CuentaBancos]
    ADD CONSTRAINT [DF_CuentaBancos_Moneda] DEFAULT ('') FOR [Moneda];


GO
PRINT N'Creating DF_CuentaBancos_CuentaBanco_Banco...';


GO
ALTER TABLE [dbo].[CuentaBancos]
    ADD CONSTRAINT [DF_CuentaBancos_CuentaBanco_Banco] DEFAULT ((0)) FOR [CuentaBanco_Banco];


GO
PRINT N'Creating DF_Beneficiarios_Nombre...';


GO
ALTER TABLE [dbo].[Beneficiarios]
    ADD CONSTRAINT [DF_Beneficiarios_Nombre] DEFAULT ('') FOR [Nombre];


GO
PRINT N'Creating DF_Cobradors_Nombre...';


GO
ALTER TABLE [dbo].[Cobradors]
    ADD CONSTRAINT [DF_Cobradors_Nombre] DEFAULT ('') FOR [Nombre];


GO
PRINT N'Creating DF_Emails_RolMail...';


GO
ALTER TABLE [dbo].[Emails]
    ADD CONSTRAINT [DF_Emails_RolMail] DEFAULT ('') FOR [RolMail];


GO
PRINT N'Creating DF_Emails_Destinatario...';


GO
ALTER TABLE [dbo].[Emails]
    ADD CONSTRAINT [DF_Emails_Destinatario] DEFAULT ('') FOR [Destinatario];


GO
PRINT N'Creating DF_Emails_Mail...';


GO
ALTER TABLE [dbo].[Emails]
    ADD CONSTRAINT [DF_Emails_Mail] DEFAULT ('') FOR [Mail];


GO
PRINT N'Creating DF_Bancos_Sigla...';


GO
ALTER TABLE [dbo].[Bancos]
    ADD CONSTRAINT [DF_Bancos_Sigla] DEFAULT ('') FOR [Sigla];


GO
PRINT N'Creating DF_Bancos_Nombre...';


GO
ALTER TABLE [dbo].[Bancos]
    ADD CONSTRAINT [DF_Bancos_Nombre] DEFAULT ('') FOR [Nombre];


GO
PRINT N'Creating DF_Giradors_Nombre...';


GO
ALTER TABLE [dbo].[Giradors]
    ADD CONSTRAINT [DF_Giradors_Nombre] DEFAULT ('') FOR [Nombre];


GO
PRINT N'Creating DF_SendMails_Fecha...';


GO
ALTER TABLE [dbo].[SendMails]
    ADD CONSTRAINT [DF_SendMails_Fecha] DEFAULT ((0)) FOR [Fecha];


GO
PRINT N'Creating DF_SendMails_RolMail...';


GO
ALTER TABLE [dbo].[SendMails]
    ADD CONSTRAINT [DF_SendMails_RolMail] DEFAULT ('') FOR [RolMail];


GO
PRINT N'Creating DF_SendMails_MailTo...';


GO
ALTER TABLE [dbo].[SendMails]
    ADD CONSTRAINT [DF_SendMails_MailTo] DEFAULT ('') FOR [MailTo];


GO
PRINT N'Creating DF_SendMails_Subject...';


GO
ALTER TABLE [dbo].[SendMails]
    ADD CONSTRAINT [DF_SendMails_Subject] DEFAULT ('') FOR [Subject];


GO
PRINT N'Creating DF_SendMails_Body...';


GO
ALTER TABLE [dbo].[SendMails]
    ADD CONSTRAINT [DF_SendMails_Body] DEFAULT ('') FOR [Body];


GO
PRINT N'Creating DF_SendMails_Codigo...';


GO
ALTER TABLE [dbo].[SendMails]
    ADD CONSTRAINT [DF_SendMails_Codigo] DEFAULT ('') FOR [Codigo];


GO
PRINT N'Creating DF_Secuencias_Catagoria...';


GO
ALTER TABLE [dbo].[Secuencias]
    ADD CONSTRAINT [DF_Secuencias_Catagoria] DEFAULT ('') FOR [Catagoria];


GO
PRINT N'Creating DF_Secuencias_Clave...';


GO
ALTER TABLE [dbo].[Secuencias]
    ADD CONSTRAINT [DF_Secuencias_Clave] DEFAULT ('') FOR [Clave];


GO
PRINT N'Creating DF_Secuencias_NroActual...';


GO
ALTER TABLE [dbo].[Secuencias]
    ADD CONSTRAINT [DF_Secuencias_NroActual] DEFAULT ((0)) FOR [NroActual];


GO
PRINT N'Creating DF_Logs_Fecha...';


GO
ALTER TABLE [dbo].[Logs]
    ADD CONSTRAINT [DF_Logs_Fecha] DEFAULT ((0)) FOR [Fecha];


GO
PRINT N'Creating DF_Logs_Usuario...';


GO
ALTER TABLE [dbo].[Logs]
    ADD CONSTRAINT [DF_Logs_Usuario] DEFAULT ('') FOR [Usuario];


GO
PRINT N'Creating DF_Logs_Objeto...';


GO
ALTER TABLE [dbo].[Logs]
    ADD CONSTRAINT [DF_Logs_Objeto] DEFAULT ('') FOR [Objeto];


GO
PRINT N'Creating DF_Logs_Metodo...';


GO
ALTER TABLE [dbo].[Logs]
    ADD CONSTRAINT [DF_Logs_Metodo] DEFAULT ('') FOR [Metodo];


GO
PRINT N'Creating DF_OperacionEMails_Enviante...';


GO
ALTER TABLE [dbo].[OperacionEMails]
    ADD CONSTRAINT [DF_OperacionEMails_Enviante] DEFAULT ('') FOR [Enviante];


GO
PRINT N'Creating DF_OperacionEMails_Destinatario...';


GO
ALTER TABLE [dbo].[OperacionEMails]
    ADD CONSTRAINT [DF_OperacionEMails_Destinatario] DEFAULT ('') FOR [Destinatario];


GO
PRINT N'Creating DF_OperacionEMails_Asunto...';


GO
ALTER TABLE [dbo].[OperacionEMails]
    ADD CONSTRAINT [DF_OperacionEMails_Asunto] DEFAULT ('') FOR [Asunto];


GO
PRINT N'Creating DF_OperacionEMails_Cuerpo...';


GO
ALTER TABLE [dbo].[OperacionEMails]
    ADD CONSTRAINT [DF_OperacionEMails_Cuerpo] DEFAULT ('') FOR [Cuerpo];


GO
PRINT N'Creating Cheque_CuentaBanco...';


GO
ALTER TABLE [dbo].[Cheques] WITH NOCHECK
    ADD CONSTRAINT [Cheque_CuentaBanco] FOREIGN KEY ([Cheque_CuentaBanco]) REFERENCES [dbo].[CuentaBancos] ([Id]) ON DELETE NO ACTION ON UPDATE NO ACTION;


GO
PRINT N'Creating Cheque_Beneficiario...';


GO
ALTER TABLE [dbo].[Cheques] WITH NOCHECK
    ADD CONSTRAINT [Cheque_Beneficiario] FOREIGN KEY ([Cheque_Beneficiario]) REFERENCES [dbo].[Beneficiarios] ([Id]) ON DELETE NO ACTION ON UPDATE NO ACTION;


GO
PRINT N'Creating Cheque_Cobrador...';


GO
ALTER TABLE [dbo].[Cheques] WITH NOCHECK
    ADD CONSTRAINT [Cheque_Cobrador] FOREIGN KEY ([Cheque_Cobrador]) REFERENCES [dbo].[Cobradors] ([Id]) ON DELETE NO ACTION ON UPDATE NO ACTION;


GO
PRINT N'Creating Cheque_Girador...';


GO
ALTER TABLE [dbo].[Cheques] WITH NOCHECK
    ADD CONSTRAINT [Cheque_Girador] FOREIGN KEY ([Cheque_Girador]) REFERENCES [dbo].[Giradors] ([Id]) ON DELETE NO ACTION ON UPDATE NO ACTION;


GO
PRINT N'Creating CuentaBanco_Banco...';


GO
ALTER TABLE [dbo].[CuentaBancos] WITH NOCHECK
    ADD CONSTRAINT [CuentaBanco_Banco] FOREIGN KEY ([CuentaBanco_Banco]) REFERENCES [dbo].[Bancos] ([Id]) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
GO
ALTER TABLE [dbo].[Cheques] WITH CHECK CHECK CONSTRAINT [Cheque_CuentaBanco];

ALTER TABLE [dbo].[Cheques] WITH CHECK CHECK CONSTRAINT [Cheque_Beneficiario];

ALTER TABLE [dbo].[Cheques] WITH CHECK CHECK CONSTRAINT [Cheque_Cobrador];

ALTER TABLE [dbo].[Cheques] WITH CHECK CHECK CONSTRAINT [Cheque_Girador];

ALTER TABLE [dbo].[CuentaBancos] WITH CHECK CHECK CONSTRAINT [CuentaBanco_Banco];
